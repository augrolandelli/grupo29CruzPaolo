...
/**
2.	Dado un �rbol binario no vac�o determinar:
 */
...
//  b.	Retornar en una estructura todos los nodos interiores (los que no son ni hojas ni ra�z)
...
//  c.	Buscar todas las ocurrencias de una clave dentro del �rbol. Retornar la posici�n de cada ocurrencia (puntero al nodo).
...
/**
3.	Para un nodo del �rbol binario determinado:
...
// b.	Escribir una funci�n que, dado un �rbol n-ario, devuelva el n�mero (cantidad) de hojas de dicho �rbol.
...
// c.	Escribir una funci�n booleana que dados dos �rboles generales determine si tienen la misma estructura, sin importar los datos del mismo (�rbol similar).
...
// d.	Retornar el padre de un nodo del �rbol (tipo_elemento).
...
// e.	Retornar los hermanos de un nodo del �rbol (lista de hermanos).
...
/**
7.	Determinar si dos �rboles binarios son equivalentes.
 */
...
// d.	Determinar si todas las hojas est�n al mismo nivel.
...
/**
9.	Generar un algoritmo, recursivo o no, que permita construir un �rbol binario de b�squeda balanceado (AVL)
	a partir de un �rbol binario sin un orden determinado.
	Comparar las alturas de ambos �rboles. Determinar la complejidad algor�tmica.
 */
